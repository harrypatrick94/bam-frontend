  ...
  return (
    ...
    <div className="ourStoryContainer">
      <div className="ourStoryParagra">
        ...
        <p className="journey"><a href="https://www.instagram.com/benson_and_the_mooch_wines/" target="_blank">Follow our journey <img src="/instagram.png" alt="Instgram" id="instagram"/></a></p>
      </div>
    </div>
  )
}
